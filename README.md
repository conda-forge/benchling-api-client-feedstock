About benchling-api-client-feedstock
====================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/benchling-api-client-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/benchling-api-client-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add benchling-api-client
# for installing globally
pixi global install benchling-api-client
```
...
It is possible to list all of the versions of `benchling-api-client` available on your platform:
...
```
pixi search benchling-api-client --channel conda-forge
```
